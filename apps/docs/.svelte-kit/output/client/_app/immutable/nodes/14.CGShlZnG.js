import{a as y,f as h}from"../chunks/CBlwNYzs.js";import"../chunks/Dwy-z0HI.js";import{s as t,f as m,e as u,$ as f,n as b}from"../chunks/CILFtpHi.js";import{h as g}from"../chunks/BElR-AbQ.js";import{C as e}from"../chunks/1IpLXSSe.js";var x=h(`<h1>@yaebal/again</h1> <p class="lead">auto-retry on 429 / flood-wait and transient 5xx errors.</p> <h2>install</h2> <!> <h2>usage</h2> <p>call <code>autoRetry(bot.api)</code> once after constructing the bot. it installs an error hook
	...
	specifically so you can unit-test a custom policy without mocking network calls.</div>`,1);function _(n){const i="pnpm add @yaebal/again",s=`import { Bot } from "@yaebal/core";
...
});`,l=`import { decideRetry, type AutoRetryOptions } from "@yaebal/again";
...
// => { retry: true, delayMs: 7000 }`;var o=x();g("1d2ypro",R=>{u(()=>{f.title="@yaebal/again — yaebal"})});var r=t(m(o),6);e(r,{code:i,title:"terminal",lang:"sh"});var a=t(r,6);e(a,{code:s,title:"bot.ts"});var d=t(a,4);e(d,{code:c,title:"bot.ts"});var p=t(d,16);e(p,{code:l,title:"policy.ts"}),b(2),y(n,o)}export{_ as component};
