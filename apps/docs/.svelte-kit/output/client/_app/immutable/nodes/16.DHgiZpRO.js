import{a as b,f as h}from"../chunks/CBlwNYzs.js";import"../chunks/Dwy-z0HI.js";import{s as e,f as u,e as m,$ as f,n as y}from"../chunks/CILFtpHi.js";import{h as g}from"../chunks/BElR-AbQ.js";import{C as t}from"../chunks/1IpLXSSe.js";var k=h(`<h1>@yaebal/callback-data</h1> <p class="lead">typed <code>callback_data</code> — pack and unpack button payloads with a field schema and full type inference.</p> <h2>install</h2> <!> <h2>usage</h2> <p>call <code>callbackData(prefix, schema)</code> once per namespace. the schema maps field
	...
	unpack data you packed yourself, so malformed values are not a concern in normal use.</div>`,1);function A(r){const n="pnpm add @yaebal/callback-data",i=`import { Bot } from "@yaebal/core";
...
});`,l=`// manual guard without pattern routing
...
});`,s=`// a namespace with no fields — useful for simple action buttons
const ping = callbackData("ping", {});
ping.pack({});    // => "ping"
ping.unpack("ping"); // => {}
ping.filter("ping"); // => true`;var a=k();g("pfbdqa",x=>{m(()=>{f.title="@yaebal/callback-data — yaebal"})});var o=e(u(a),6);t(o,{code:n,title:"terminal",lang:"sh"});var d=e(o,6);t(d,{code:i,title:"bot.ts"});var c=e(d,6);t(c,{code:l,title:"filter.ts"});var p=e(c,6);t(p,{code:s,title:"prefix-only.ts"}),y(14),b(r,a)}export{A as component};
