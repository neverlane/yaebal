import{a as y,f as x}from"../chunks/CBlwNYzs.js";import"../chunks/Dwy-z0HI.js";import{s as t,f as v,e as S,$ as B,n as j}from"../chunks/CILFtpHi.js";import{h as C}from"../chunks/BElR-AbQ.js";import{C as e}from"../chunks/1IpLXSSe.js";var T=x(`<h1>@yaebal/morda</h1> <p class="lead">dialogs engine + jsx/hooks layer. declarative windows, automatic callback routing, per-chat
	navigation stack — and an optional "react-for-telegram" surface where screens are components and
	state is managed with hooks.</p> <h2>install</h2> <!> <h2>the dialogs API</h2> <p>the core export is <code>dialogs(def, options?)</code>. a <em>dialog</em> is a flat map of named
	...
	the stack, so reopened screens re-mount fresh.</div>`,1);function $(l){const h="pnpm add @yaebal/morda",g=`import { Bot } from "@yaebal/core";
...
bot.start();`,u=`// ctx.dialog is available on every update after .install(dialogs(...))
...
await ctx.dialog.rerender();`,p=`import { switchTo, back, button } from "@yaebal/morda";
...
});`,m=`import { dialogs } from "@yaebal/morda";
...
bot.install(dialogs(def, { storage: new RedisDialogStorage() }));`,b=`// tsconfig.json — point the compiler at morda's jsx transform
{
  "compilerOptions": {
    "jsx": "react-jsx",
    "jsxImportSource": "@yaebal/morda"
  }
}`,w=`/** @jsxImportSource @yaebal/morda */
...
bot.command("menu", (ctx) => ctx.dialog.start("main"));
bot.start();`,f=`/** @jsxImportSource @yaebal/morda */
import {
  Screen, Button,
...
}`;var o=T();C("rhaq5n",D=>{S(()=>{B.title="@yaebal/morda — yaebal"})});var d=t(v(o),6);e(d,{code:h,title:"terminal",lang:"sh"});var a=t(d,6);e(a,{code:g,title:"menu.ts"});var n=t(a,6);e(n,{code:u,title:"navigation.ts"});var s=t(n,8);e(s,{code:p,title:"buttons.ts"});var r=t(s,8);e(r,{code:m,title:"custom-storage.ts"});var c=t(r,10);e(c,{code:b,title:"tsconfig.json",lang:"text"});var i=t(c,2);e(i,{code:w,title:"bot.tsx"});var k=t(i,4);e(k,{code:f,title:"hooks.tsx"}),j(12),y(l,o)}export{$ as component};
