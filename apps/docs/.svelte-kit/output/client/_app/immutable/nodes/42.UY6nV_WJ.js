import{a as c,f as l}from"../chunks/CBlwNYzs.js";import"../chunks/Dwy-z0HI.js";import{s as e,f as p,e as m,$ as f,n as u}from"../chunks/CILFtpHi.js";import{h as b}from"../chunks/BElR-AbQ.js";import{C as t}from"../chunks/1IpLXSSe.js";var y=l(`<h1>@yaebal/workers</h1> <p class="lead">a tiny <code>worker_threads</code> pool — keep the bot on the main loop and offload only the
	CPU-heavy bits to threads.</p> <h2>install</h2> <!> <h2>when to reach for it</h2> <p>Most handlers are I/O-bound and are already served by <a href="/docs/runner/">@yaebal/runner</a>'s
	concurrency. Threads help only for genuinely CPU-heavy work: image processing, crypto, heavy
	parsing. Offload <em>that</em> — not the whole bot.</p> <h2>usage</h2> <p>Register tasks in a worker file, then call them from a handler:</p> <!> <!> <h2>how it works</h2> <p>The main thread posts <code>name</code> + <code>arg</code> to the next worker (round-robin); the
	...
	closures with the main thread — they only receive the data you pass to <code>run</code>.</div>`,1);function _(s){const d="pnpm add @yaebal/workers",n=`// tasks.ts — runs in a worker thread
...
});`,h=`// bot — stays on the main event loop
...
});`;var o=y();b("10yavgk",w=>{m(()=>{f.title="@yaebal/workers — yaebal"})});var r=e(p(o),6);t(r,{code:d,title:"terminal",lang:"sh"});var a=e(r,10);t(a,{code:n,title:"tasks.ts"});var i=e(a,2);t(i,{code:h,title:"bot.ts"}),u(10),c(s,o)}export{_ as component};
