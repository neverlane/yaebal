<script lang="ts">
  ...
  import type { CallbackQueryContext, InlineQueryContext, MessageContext, PreCheckoutQueryContext } from "@yaebal/contexts";
  ...
  export class PreCheckoutQueryContext extends Context { id: string; from: t.User; invoice_payload: string; answer(ok: boolean, params?: { error_message?: string }): Promise<boolean>; }
