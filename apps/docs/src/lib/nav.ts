...
export const nav: NavSection[] = [
	{
		...
		items: [
			...
			{ label: "ai tooling", href: "/docs/llms", badge: "new" },
	...
	},
	{
		...
		items: [
			...
			{ label: "cache", href: "/docs/plugins/cache" },
			{ label: "feature-flags", href: "/docs/plugins/feature-flags" },
			{ label: "i18n", href: "/docs/plugins/i18n" },
			{ label: "scenes", href: "/docs/plugins/scenes" },
			{ label: "state-machine", href: "/docs/plugins/state-machine" },
			...
			{ label: "ai (llm chat)", href: "/docs/plugins/ai", badge: "new" },
	...
	},
	{
		...
		items: [
			...
			{ label: "guards", href: "/docs/plugins/guards" },
			{ label: "commands", href: "/docs/plugins/commands" },
			{ label: "payments", href: "/docs/plugins/payments" },
			{ label: "mini-app", href: "/docs/plugins/mini-app" },
		],
	},
	{
		title: "plugins / media",
	...
	},
	{
		...
		items: [
			...
			{ label: "cron", href: "/docs/plugins/cron" },
			{ label: "panel", href: "/docs/plugins/panel" },
			{ label: "analytics", href: "/docs/plugins/analytics" },
			{ label: "audit-log", href: "/docs/plugins/audit-log" },
		],
	},
	{
		title: "scaling",
