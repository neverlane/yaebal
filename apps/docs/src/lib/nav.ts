...
export const nav: NavSection[] = [
	{
		...
		items: [
			...
			{ label: "recipes", href: "/docs/recipes", badge: "new" },
			{ label: "comparison", href: "/docs/comparison", badge: "new" },
	...
	},
	{
		...
		items: [
			...
			{ label: "local bot api", href: "/docs/production/local-bot-api", badge: "new" },
			{ label: "rate limits", href: "/docs/production/rate-limits", badge: "new" },
			{ label: "deploy targets", href: "/docs/production/deploy-targets", badge: "new" },
			{ label: "observability", href: "/docs/production/observability", badge: "new" },
			{ label: "queues & broadcasts", href: "/docs/production/queues-broadcasts", badge: "new" },
	...
	},
	{
		title: "reference",
		items: [
			{ label: "public api reference", href: "/docs/reference", badge: "new" },
