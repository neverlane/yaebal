...
<p>
	...
	<code>ctx.message</code> already resolves <code>message</code> / <code>edited_message</code> /
	<code>channel_post</code>, and <code>ctx.text</code> falls back from text to caption.
</p>
...
<p>
	...
	update. <code>send</code> accepts a plain string or a <code>format</code> result;
	<code>reply</code> sets <code>reply_parameters</code> for you; the media shortcuts accept a
	<code>MediaSource</code> or a raw <code>file_id</code>/url string.
</p>
