...
export interface ChatJoinRequestContextBase extends t.ChatJoinRequest {}
export class ChatJoinRequestContextBase {
	readonly api: Api;
	readonly update: t.Update;
	constructor(api: Api, update: t.Update) {
		this.api = api;
		this.update = update;
		Object.assign(this, update.chat_join_request ?? {});
	}
