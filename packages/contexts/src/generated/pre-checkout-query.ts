...
export interface PreCheckoutQueryContextBase extends t.PreCheckoutQuery {}
export class PreCheckoutQueryContextBase {
	readonly api: Api;
	readonly update: t.Update;
	constructor(api: Api, update: t.Update) {
		this.api = api;
		this.update = update;
		Object.assign(this, update.pre_checkout_query ?? {});
	}
	...
	answer(params: Omit<t.AnswerPreCheckoutQueryParams, "pre_checkout_query_id">) {
		return this.api.call<boolean>("answerPreCheckoutQuery", { pre_checkout_query_id: this.id, ...params });
	}
