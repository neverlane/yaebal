...
export interface ShippingQueryContextBase extends t.ShippingQuery {}
export class ShippingQueryContextBase {
	readonly api: Api;
	...
	answer(params: Omit<t.AnswerShippingQueryParams, "shipping_query_id">) {
		return this.api.call<boolean>("answerShippingQuery", { shipping_query_id: this.id, ...params });
	}
